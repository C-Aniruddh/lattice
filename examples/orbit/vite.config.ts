 ...
 * than into a different number in the banner. 5180 for the same reason 5179 belongs to `harbor`: it is the next number nothing else answers on.
 *
...
export default defineConfig({
  server: { port: 5180, fs: { allow: [root] } },
});
