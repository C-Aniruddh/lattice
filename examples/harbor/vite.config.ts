 ...
 * than into a different number in the banner. 5179 because 5173–5178 are spoken for and 5181 upward belongs to the exhibits that landed before this one.
 *
...
export default defineConfig({
  server: { port: 5179, fs: { allow: [root] } },
});
