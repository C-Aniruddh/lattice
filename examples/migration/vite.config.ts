 ...
 * than into a different number in the banner. 5201, next to `replay` because the two of them are the persistence pair and are usually opened together.
 *
...
export default defineConfig({
  server: { port: 5201, fs: { allow: [root] } },
});
